...
public class DatabaseChangeLog {
	...
	public void insertBooks(DB db) {
		...
		BasicDBObject comment = new BasicDBObject().append("readerNickName", "TestReaderName").append("commentText",
				"TestComment").append("book", new DBRef("books", books.findOne(doc).get("_id")));
